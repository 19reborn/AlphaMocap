...
python scripts/preprocess/extract_video.py D:/Study/2021_Research/animation/experiments/EasyMocap-master/datasets/demo --handface /
# 2.1 example for SMPL reconstruction
python apps/demo/mv1p.py D:/Study/2021_Research/animation/experiments/EasyMocap-master/datasets/demo --out D:/Study/2021_Research/animation/experiments/EasyMocap-master/datasets/demo/output/smpl --vis_det --vis_repro --undis --sub_vis 1 7 13 19 --vis_smpl 
